    ...
    <div class="hero-body">
        <div class="container">
            ...
            <div class="column is-12">
                ...
                {!! Form::open( ['url'=> action('Circulars@store'), 'enctype'=>'multipart/form-data', 'class'=>'columns is-multiline' ]) !!}
                    ...
                    <div class="column form-group is-6-desktop is-12-mobile">
                        <div class="input-group">
                            ...
                            {!! Form::text('deadline_date', old('deadline_date') , ['class'=>'form-control datepicker', 'aria-describedby'=> 'deadline_date']) !!}
                        </div>
                    </div>
                            
                    <div class="column form-group is-12">
                        {!! Form::label('circular_detail', 'CIRCULAR DETAIL: ') !!}
                        {!! Form::textarea('circular_detail', old('circular_detail') , ['class'=>'form-control summernote']) !!}
                    </div>
