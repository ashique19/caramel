...
{!! Form::open(['action'=>'Users@store', 'role'=>'form', 'class'=>'form', 'enctype'=>'multipart/form-data' ]) !!}
    ...
    <div class="form-group">
        ...
        {!! Form::select('role', \App\Role::pluck('name','id'), old('role'), ['class'=>'form-control']) !!}
    </div>
    ...
    <div class="form-group">
        ...
        {!! Form::select('country_id', \App\Country::pluck('name','id'), old('country_id'), ['class'=>'form-control select2']) !!}
    </div>
