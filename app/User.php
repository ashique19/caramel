...
class User extends Authenticatable
{
     ...
     * @var array
     */
    protected $fillable = ['username', 'email', 'password', 'role', 'firstname', 'lastname', 'name', 'address', 'area', 'city', 'state', 'postcode', 'country_id', 'parmanent_address', 'active', 'contact', 'referrer_id', 'referral_balance', 'referral_benefit_expiry_date', 'expiry_date', 'balance', 'user_photo', 'created_by','updated_by'];
